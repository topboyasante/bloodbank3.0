            ...
            <div className="grid lg:grid-cols-3 sm:grid-cols-2 sm:grid-rows-3 lg:mt-[80px] lg:ml-[93px]">
                ...
                <div className="border-2 w-[180px] h-[149px] rounded-2xl shadow-md lg:mb-[77px] sm:mb-[20px] cursor-pointer">
                    <div className="text-dark-red">
                        ...
                        <h1 className = "pt-6 text-3xl "><TfiBell/></h1>
                        </center>
                    </div>
                </div>
                ...
                <div className="border-2 w-[180px] h-[149px] rounded-2xl shadow-md lg:mb-[77px] sm:mb-[20px] cursor-pointer">
                    <div className="text-dark-red">
                        ...
                        <h1 className = "pt-6 text-3xl "><MdOutlineSwitchAccount/></h1>
                        </center>
                    </div>
                </div>
                </Link>
                ...
                <div className="border-2 w-[180px] h-[149px] rounded-2xl shadow-md lg:mb-[77px] sm:mb-[20px] cursor-pointer">
                    <div className="text-dark-red">
                        ...
                        <h1 className = "pt-6 text-3xl "><TiSpanner/></h1>
                        </center>
                    </div>
                </div>
                ...
                <div className="border-2 w-[180px] h-[149px] rounded-2xl shadow-md cursor-pointer">
                    <div className="text-dark-red">
                        ...
                        <h1 className = "pt-6 text-3xl "><MdSecurity/></h1>
                        </center>
                    </div>
                </div>
                ...
                <div className="border-2 w-[180px] h-[149px] rounded-2xl shadow-md cursor-pointer">
                    <div className="text-dark-red">
                        ...
                        <h1 className = "pt-6 text-3xl "><AiOutlineInfoCircle/></h1>
                        </center>
                    </div>
                </div>
                ...
                <div className="border-2 w-[180px] h-[149px] rounded-2xl shadow-md cursor-pointer">
                    <div className="text-dark-red">
                        ...
                        <h1 className = "pt-6 text-3xl "><AiOutlineQuestionCircle/></h1>
                        </center>
                    </div>
                </div>
